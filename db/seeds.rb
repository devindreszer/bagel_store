...
Neighborhood.create!(id: 1, neighborhood_name: 'Allston', delivery_charge: 11)
Neighborhood.create!(id: 2, neighborhood_name: 'Back Bay', delivery_charge: 6)
Neighborhood.create!(id: 3, neighborhood_name: 'Bay Village', delivery_charge: 6)
Neighborhood.create!(id: 4, neighborhood_name: 'Beacon Hill', delivery_charge: 6)
Neighborhood.create!(id: 5, neighborhood_name: 'Brighton', delivery_charge: 11)
Neighborhood.create!(id: 6, neighborhood_name: 'Brookline', delivery_charge: 11)
Neighborhood.create!(id: 7, neighborhood_name: 'Cambridge', delivery_charge: 11)
Neighborhood.create!(id: 8, neighborhood_name: 'Charlestown', delivery_charge: 6)
Neighborhood.create!(id: 9, neighborhood_name: 'Chinatown/Leather District', delivery_charge: 6)
Neighborhood.create!(id: 10, neighborhood_name: 'Dorchester', delivery_charge: 11)
Neighborhood.create!(id: 11, neighborhood_name: 'Downtown', delivery_charge: 6)
Neighborhood.create!(id: 12, neighborhood_name: 'Fenway Kenmore', delivery_charge: 6)
Neighborhood.create!(id: 13, neighborhood_name: 'Hyde Park', delivery_charge: 11)
Neighborhood.create!(id: 14, neighborhood_name: 'Jamaica Plain', delivery_charge: 11)
Neighborhood.create!(id: 15, neighborhood_name: 'Mattapan', delivery_charge: 11)
Neighborhood.create!(id: 16, neighborhood_name: 'Mid Dorchester', delivery_charge: 11)
Neighborhood.create!(id: 17, neighborhood_name: 'Mission Hill', delivery_charge: 11)
Neighborhood.create!(id: 18, neighborhood_name: 'North End', delivery_charge: 6)
Neighborhood.create!(id: 19, neighborhood_name: 'Roslindale', delivery_charge: 11)
Neighborhood.create!(id: 20, neighborhood_name: 'Roxbury', delivery_charge: 11)
Neighborhood.create!(id: 21, neighborhood_name: 'Somerville', delivery_charge: 11)
Neighborhood.create!(id: 22, neighborhood_name: 'South Boston', delivery_charge: 6)
Neighborhood.create!(id: 23, neighborhood_name: 'South End', delivery_charge: 6)
Neighborhood.create!(id: 24, neighborhood_name: 'West End', delivery_charge: 6)
Neighborhood.create!(id: 25, neighborhood_name: 'West Roxbury', delivery_charge: 11)
